                ...
                {highlights.map((item, i) => {
                  ...
                  return (
                    <div
                      ...
                      data-aos="fade-up"
                      data-aos-delay={i * 50}
                      className="group relative p-6 md:p-8 flex flex-col md:flex-row md:items-center gap-6 
                   transition-all duration-300 hover:bg-muted/30 first:rounded-t-3xl last:rounded-b-3xl"
                    >
                      {/* Number & Icon Block */}
          ...
          <section className="py-20 bg-[#F6F6F6]">
            <div className="container mx-auto px-6 max-w-5xl">
              <SectionHeading
                ...
                subtitle={
                  lang === "ja"
                    ? " 日本企業のインド進出・事業拡大を成功に導く、実績あるステップバイステップのアプローチをご紹介します。"
                    : "Our proven, step-by-step approach ensures successful outcomes for our clients in India."
                }
              />
