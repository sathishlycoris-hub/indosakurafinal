// resources/js/Pages/Recruitment/JobDetails.tsx
...
export default function JobDetail({ job }: { job: Job }) {
  ...
  const { jobs, lang, pageSeo } = usePage<{
    jobs: Job[];
    lang: "en" | "ja";
  ...
  return (
    <Layout>
      ...
      <div className="sticky top-16 lg:top-[101px] z-40 bg-white">
        <Recruitmenthead jobs={jobs} currentSlug={job.slug} />
      </div>
      ...
      <section className="hero-gradient text-primary-foreground py-16 lg:py-16">
        <div className="container mx-auto px-4 lg:px-8" data-aos="fade-right">
          ...
          <div className="flex flex-wrap gap-4 text-sm">
            <span>{getLangValue(lang, job.location, job.location_ja)}</span>
            <span>{getLangValue(lang, job.employment_type, job.employment_type_ja)}</span>
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2 space-y-12">
              ...
              {[
                ["responsibilities", getLangValue(lang, "Key Responsibilities", "主な業務内容")],
                ["requirements",     getLangValue(lang, "Requirements",          "応募条件")],
                ["preferred",        getLangValue(lang, "Preferred Qualifications", "歓迎条件")],
                ["offer",            getLangValue(lang, "What We Offer",          "待遇・福利厚生")],
              ].map(([type, title]) => {
                const items = getSection(type as JobSection["section_type"]);
